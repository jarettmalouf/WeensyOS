...
static inline pid_t sys_getpid(void) {
  ...
  10001a:	e8 45 0b 00 00       	callq  100b64 <app_printf>
// sys_fork()
...
static inline pid_t sys_fork(void) {
  ...
  10002a:	e8 29 03 00 00       	callq  100358 <srand>
    if(fork != 0){
...
child:;
  ...
  100039:	e8 1a 03 00 00       	callq  100358 <srand>
...
static inline uintptr_t read_rsp(void) {
  ...
  10008d:	e8 d2 0a 00 00       	callq  100b64 <app_printf>
  ...
  10009c:	e8 7d 02 00 00       	callq  10031e <rand>
  ...
  1000d3:	e8 e9 0b 00 00       	callq  100cc1 <assert_fail>
void process_main(void) {
  ...
  1000f2:	e8 6d 0a 00 00       	callq  100b64 <app_printf>
...
static inline void sys_exit(void) {
 ...
 spinloop: goto spinloop;       // should never get here
  ...
  1000fb:	cd 32                	int    $0x32
            if ((rand() % ALLOC_SLOWDOWN) < p) {
  1000fd:	e8 1c 02 00 00       	callq  10031e <rand>
...
void printer_vprintf(printer* p, int color, const char* format, va_list val) {
  ...
  100392:	e9 a4 04 00 00       	jmpq   10083b <printer_vprintf+0x4d2>
  ...
  1003ba:	e8 37 ff ff ff       	callq  1002f6 <strchr>
  ...
  100415:	ff 24 c5 40 0d 10 00 	jmpq   *0x100d40(,%rax,8)
  ...
  10047b:	e9 6f ff ff ff       	jmpq   1003ef <printer_vprintf+0x86>
            width = va_arg(val, int);
  ...
  100498:	e9 52 ff ff ff       	jmpq   1003ef <printer_vprintf+0x86>
        int width = -1;
  10049d:	41 bd ff ff ff ff    	mov    $0xffffffff,%r13d
  1004a3:	e9 47 ff ff ff       	jmpq   1003ef <printer_vprintf+0x86>
            ++format;
  ...
  1004c6:	e9 34 ff ff ff       	jmpq   1003ff <printer_vprintf+0x96>
  ...
  100518:	e9 e2 fe ff ff       	jmpq   1003ff <printer_vprintf+0x96>
                precision = va_arg(val, int);
  ...
  100534:	e9 f3 00 00 00       	jmpq   10062c <printer_vprintf+0x2c3>
            ++format;
  100539:	48 83 c3 01          	add    $0x1,%rbx
            length = 1;
  10053d:	b9 01 00 00 00       	mov    $0x1,%ecx
            goto again;
  100542:	e9 bd fe ff ff       	jmpq   100404 <printer_vprintf+0x9b>
  ...
  100583:	41 bc 01 0d 10 00    	mov    $0x100d01,%r12d
            break;
  100589:	e9 35 01 00 00       	jmpq   1006c3 <printer_vprintf+0x35a>
            long x = length ? va_arg(val, long) : va_arg(val, int);
  ...
  100622:	e9 e2 02 00 00       	jmpq   100909 <printer_vprintf+0x5a0>
            base = 16;
  ...
  100662:	e9 a2 02 00 00       	jmpq   100909 <printer_vprintf+0x5a0>
  ...
  100726:	e8 63 fb ff ff       	callq  10028e <strnlen>
  ...
  100748:	e8 26 fb ff ff       	callq  100273 <strlen>
  ...
  100864:	e9 51 fe ff ff       	jmpq   1006ba <printer_vprintf+0x351>
  ...
  1008b9:	41 b8 00 00 00 00    	mov    $0x0,%r8d
            break;
  1008bf:	e9 ff fd ff ff       	jmpq   1006c3 <printer_vprintf+0x35a>
            numbuf[0] = va_arg(val, int);
  ...
  1008f4:	e9 ca fd ff ff       	jmpq   1006c3 <printer_vprintf+0x35a>
        if (flags & FLAG_NUMERIC) {
  ...
  100939:	e9 9a fd ff ff       	jmpq   1006d8 <printer_vprintf+0x36f>
                prefix = "-";
  ...
  100975:	e9 87 fd ff ff       	jmpq   100701 <printer_vprintf+0x398>
                   && (base == 16 || base == -16)
  ...
  1009b1:	e9 4b fd ff ff       	jmpq   100701 <printer_vprintf+0x398>
            len = strlen(data);
  1009b6:	4c 89 e7             	mov    %r12,%rdi
  1009b9:	e8 b5 f8 ff ff       	callq  100273 <strlen>
  ...
  1009e9:	e9 56 fd ff ff       	jmpq   100744 <printer_vprintf+0x3db>
                   && len + (int) strlen(prefix) < width) {
  1009ee:	48 8b 7d a0          	mov    -0x60(%rbp),%rdi
  1009f2:	e8 7c f8 ff ff       	callq  100273 <strlen>
  ...
  100a12:	e9 2d fd ff ff       	jmpq   100744 <printer_vprintf+0x3db>
            numbuf[0] = (*format ? *format : '%');
  ...
  100a28:	e9 96 fc ff ff       	jmpq   1006c3 <printer_vprintf+0x35a>
        int flags = 0;
  100a2d:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
  100a34:	e9 b0 f9 ff ff       	jmpq   1003e9 <printer_vprintf+0x80>
}
...
int console_vprintf(int cpos, int color, const char* format, va_list val) {
  ...
  100a79:	e8 eb f8 ff ff       	callq  100369 <printer_vprintf>
...
int console_printf(int cpos, int color, const char* format, ...) {
  ...
  100abc:	e8 87 ff ff ff       	callq  100a48 <console_vprintf>
}
  100ac1:	c9                   	leaveq 
  100ac2:	c3                   	retq   
...
int vsnprintf(char* s, size_t size, const char* format, va_list val) {
  ...
  100afd:	e8 67 f8 ff ff       	callq  100369 <printer_vprintf>
        *sp.s = 0;
...
int snprintf(char* s, size_t size, const char* format, ...) {
  ...
  100b3a:	e8 84 ff ff ff       	callq  100ac3 <vsnprintf>
    va_end(val);
    return n;
}
  100b3f:	c9                   	leaveq 
...
void app_printf(int colorid, const char* format, ...) {
  ...
  100bda:	e8 69 fe ff ff       	callq  100a48 <console_vprintf>
    va_end(val);
...
void panic(const char* format, ...) {
  ...
  100c3f:	e8 ab f5 ff ff       	callq  1001ef <memcpy>
  ...
  100c57:	e8 67 fe ff ff       	callq  100ac3 <vsnprintf>
  ...
  100c8d:	e8 fb fd ff ff       	callq  100a8d <console_printf>
}
...
static inline pid_t __attribute__((noreturn)) sys_panic(const char* msg) {
 ...
 loop: goto loop;
  ...
  100cba:	e8 f2 f5 ff ff       	callq  1002b1 <strcpy>
...
void assert_fail(const char* file, int line, const char* msg) {
  ...
  100ce2:	e8 a6 fd ff ff       	callq  100a8d <console_printf>
    asm volatile ("int %0" : /* no result */
